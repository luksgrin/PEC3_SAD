...
muertes por millón de habitantes. Para este caso, vemos que existen correlacione negativas entre el número de muertes
...
summary(modelo)
```
En este modelo observamos un ligreo incremento en R cuadrado y que el efecto del predictor vaccination_2020_2015 no
...
Suiza y Méjico; y otros dos clusters más. Es posible asumir que estas distancias, por cómo han sido computadas, se deben a 
